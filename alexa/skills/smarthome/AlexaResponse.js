...
class AlexaResponse {
        ...
        if (opts.event !== undefined)
            ...
            this.event = {
                header: {
                    ...
                    messageId: this.checkValue(opts.messageId, Math.floor(Math.random() * 10000)),
    ...
    addPayloadEndpoint(opts) {
        ...
        this.event.payload.endpoints = opts;
    ...
    createContextProperty(opts) {
        ...
        return {
            ...
            uncertaintyInMilliseconds: this.checkValue(opts.uncertaintyInMilliseconds, 6000)
        };
